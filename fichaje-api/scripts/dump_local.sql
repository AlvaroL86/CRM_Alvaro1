...
INSERT INTO `roles` VALUES ('admin','Admin','Acceso total','{\"modules\":{\"dashboard\":{\"active\":true,\"actions\":{\"view\":true}},\"chat\":{\"active\":true,\"actions\":{\"view\":true,\"send\":true,\"manage\":true}},\"fichajes\":{\"active\":true,\"actions\":{\"listar\":true,\"crear\":true,\"aprobar\":true}},\"clientes\":{\"active\":true,\"actions\":{\"listar\":true,\"crear\":true,\"editar\":true,\"eliminar\":true}},\"tickets\":{\"active\":true,\"actions\":{\"listar\":true,\"crear\":true,\"editar\":true,\"cerrar\":true}},\"usuarios\":{\"active\":true,\"actions\":{\"usersview\":true,\"userscreate\":true,\"usersedit\":true,\"usersdelete\":true}}}}'),('empleado','Empleado','Acceso básico','[\"fichajes:crear\", \"fichajes:listar\"]'),('supervisor','Supervisor','Permisos medios','[\"users:view\", \"users:edit\"]'),('tecnico-soporte','Tecnico Soporte','Tecnico','[]');
